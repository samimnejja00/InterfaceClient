...
function StatusSummary({ stats }) {
  const statuses = [
    ...
    { key: 'annule', label: 'Annulé', value: stats.annule || 0, color: '#EF4444', bgColor: 'bg-red-50', textColor: 'text-red-600', icon: <XIcon /> },
  ...
  const total = (stats.enInstance || 0) + (stats.enCours || 0) + (stats.annule || 0) + (stats.cloture || 0) + (stats.rejete || 0);
